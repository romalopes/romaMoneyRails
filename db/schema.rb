...
ActiveRecord::Schema.define(version: 20131130023819) do
  ...
  add_index "user_accounts", ["user_id", "account_id"], name: "index_user_accounts_on_user_id_and_account_id", unique: true
